...
export default function Contactus() {
  ...
  return (
    <>
    <Navbar/>
    <div className="isolate bg-white px-6 pb-24 pt-10 sm:pb-32 lg:px-0">
      <div
        aria-hidden="true"
      ...
      <div className=" text-center bg-[#111827] w-full py-20">
        <h2 className="text-balance text-4xl font-semibold tracking-tight text-white sm:text-5xl">Contact Us</h2>
        <p className="mt-2 text-lg/8 text-white">We will Provide you Best services at your Door house. Let's contact us Now</p>
      </div>
