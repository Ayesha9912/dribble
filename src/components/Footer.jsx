...
function Footer(){
  ...
  return (
<<<<<<< HEAD
 <footer className='md:px-16 lg:px-28 bg-gray-900 sticky h-fit'>
  <div className='grid md:grid-cols-2 md:grid md:cols-2 md:gap-8'>
    <div className='m-5'>
        <h2 className='text-white md:text-3xl mt-10'>It's time to support zero pullotion,</h2>
        <h2 className='text-gray-400 md:text-2xl mt-2'>with renewable resources</h2>
        <div className='md:flex flex-cols mt-2'>
        <div className='flex md:items-center gap-1'>
            <CheckCircleIcon className='text-green-600 w-4 h-4'/>
            <p className='text-md text-gray-400'>experience of more than 10 years</p>
        </div>
    ...
    <div className='md:m-5 ml-3'>
    <p className='text-gray-400 md:mt-10 mb-2'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil error voluptatum reiciendis sed ex. Modi doloribus facere ea</p>
    <button className='btn bg-white rounded-2xl py-1 px-3 hover:bg-gray-800 hover:text-white'>  Get In Touch </button>
  </div>
  <div className="md:flex gap-10">
  <div className='flex ml-2 mt-5'>
  <BeakerIcon className='w-7 h-7 text-green-600'/>
   <h2 className='text-gray-400'>Xurya</h2>
  </div>
...
=======
 <footer className='md:px-10 lg:px-20 bg-gray-900 sticky w-fit h-full p-0'>
  <div className='grid md:grid-cols-2 md:grid md:cols-2 md:gap-4'>
    <div className='m-2'>
        <h2 className='text-white md:text-3xl mt-10'>It's time to support zero pullotion,</h2>
        <h2 className='text-gray-400 md:text-2xl mt-2 text-sm md:text-md'>with renewable resources</h2>
        <div className='md:flex flex-cols mt-2'>
        <div className='flex md:items-center gap-1'>
            <CheckCircleIcon className='text-green-600 w-4 h-4'/>
            <p className='text-md text-gray-400 text-sm md:text-md'>experience of more than 10 years</p>
        </div>
         <span className='flex items-center gap-1 md:ml-3'>
            <CheckCircleIcon className='text-green-600 w-4 h-4'/>
            <p className='text-md text-gray-400 text-sm md:text-md'>experience of more than 10 years</p>
    ...
    <p className='text-gray-400 md:mt-10 mb-2 text-sm md:text-md'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nihil error voluptatum reiciendis sed ex. Modi doloribus facere ea</p>
    <button className='btn bg-white rounded-2xl md:py-1 md:px-3 hover:bg-gray-800 hover:text-white px-2 py-1 text-sm md:text-md mt-2'>  Get In Touch </button>
  </div>
  <div className="md:flex gap-10">
  <div className='flex gap-10 mt-5'>
   <h2 className='text-gray-400 text-xl md:text-md ml-3 md:ml-0'>Xurya</h2>
  </div>
  <ul className='md:flex translate-all duration-500 ease-in text-gray-400 gap-4  text-md  md:mb-0 mt-3 ml-3'>
          {
...
<<<<<<< HEAD
      <div className='md:flex gap-3 md:ml-20 md:pl-20 ml-3 mt-3'>
      <button class="m-2 w-10 h-10 flex items-center relative overflow-hidden justify-center rounded-full bg-gray-400 shadow-md shadow-gray-400 group transition-all duration-300">
=======
      <div className='flex md:gap-1 mt-3 ml-36'>
      <button class="m-1  w-7 h-7 md:h-10 flex items-center relative overflow-hidden justify-center rounded-full bg-gray-400 shadow-md shadow-gray-400 group transition-all duration-300">
>>>>>>> a86adcb171c94eadcf933f64ac450cc0e814a574
...
<<<<<<< HEAD
      <button class="m-2 w-10 h-10 flex items-center justify-center relative overflow-hidden rounded-full bg-gray-400 shadow-md shadow-gray-400 group transition-all duration-300">
=======
      <button class="m-1  md:h-10 w-7 h-7 flex items-center justify-center relative overflow-hidden rounded-full bg-gray-400 shadow-md shadow-gray-400 group transition-all duration-300">
>>>>>>> a86adcb171c94eadcf933f64ac450cc0e814a574
...
<<<<<<< HEAD
      <button class="m-2 w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden bg-gray-400 shadow-md shadow-gray-400 group transition-all duration-500">
=======
      <button class="m-1  md:h-10 h-7 w-7 flex items-center justify-center rounded-full relative overflow-hidden bg-gray-400 shadow-md shadow-gray-400 group transition-all duration-500">
>>>>>>> a86adcb171c94eadcf933f64ac450cc0e814a574
...
<<<<<<< HEAD
      <button class="m-2 w-10 h-10 flex items-center justify-center rounded-full relative overflow-hidden bg-gray-400 shadow-md shadow-gray-400 group transition-all duration-300">
=======
      <button class="m-1  md:h-10 w-7 h-7 flex items-center justify-center rounded-full relative overflow-hidden bg-gray-400 shadow-md shadow-gray-400 group transition-all duration-300">
>>>>>>> a86adcb171c94eadcf933f64ac450cc0e814a574
      <svg class="fill-black z-10 transition-all duration-300 group-hover:fill-white" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72" fill="none">
      <path
  ...
  <hr className=" w-full" />
  <div className='md:flex  md:gap-3 m-3'>
    <p className='text-gray-400'>2024 Xurya Inc. All rights reserved</p>
    <p className='text-gray-400 md:ml-80 cursor-pointer hover:text-white'>privacy policy</p>
